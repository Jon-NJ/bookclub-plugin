    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_profile_help exception ${e.message}`);
                return;
            }
        ...
        .fail(function (jqXHR, text, error) {
            console.log(`bc_profile_help ${text} ${error}`);
    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_email_test exception ${e.message}`);
                return;
            }
            handle_result(json['error'], json['message']);
        })
        .fail(function (jqXHR, text, error) {
            console.log(`bc_email_test ${text} ${error}`);
            handle_result(true, error);
        });
});
        ...
        jQuery.ajax({
            ...
            .done(function (data) {
                ...
                try {
                    ...
                    console.log(`bc_reset_key exception ${e.message}`);
                    return;
                }
                handle_result(json['error'], json['message']);
            ...
            .fail(function (jqXHR, text, error) {
                console.log(`bc_reset_key ${text} ${error}`);
                handle_result(true, error);
            });
    }
});
        ...
        jQuery.ajax({
            ...
            .done(function (data) {
                ...
                try {
                    ...
                    console.log(`bc_profile_delete exception ${e.message}`);
                    return;
                }
                handle_result(json['error'], json['message'], json['redirect']);
            })
            .fail(function (jqXHR, text, error) {
                console.log(`bc_profile_delete ${text} ${error}`);
            });
    }
});
    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_profile_update exception ${e.message}`);
                return;
            }
            if (json['upcoming']) {
        ...
        .fail(function (jqXHR, text, error) {
            console.log(`bc_profile_update ${text} ${error}`);
        });
}
...
function update_profile_check(e) {
    ...
    if (pkey.length) {
        ...
        jQuery.ajax({
            ...
            .fail(function (jqXHR, text, error) {
                console.log(`bc_wordpress_update ${text} ${error}`);
            });
    }
}
    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_profile_heartbeat exception ${e.message}`);
                return;
            }
            handle_result(json['error'], json['message']);
        ...
        .fail(function (jqXHR, text, error) {
            console.log(`bc_profile_heartbeat ${text} ${error}`);
        });
}
