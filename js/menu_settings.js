    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_settings_help exception ${e.message}`);
                return;
            }
        ...
        .fail(function (jqXHR, text, error) {
            console.log(`bc_settings_help ${text} ${error}`);
    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_settings_save exception ${e.message}`);
                return;
            }
            handle_result(json['error'], json['message'], json['redirect']);
        })
        .fail(function (jqXHR, text, error) {
            console.log(`bc_settings_save ${text} ${error}`);
            handle_result(true, error);
        });
});
    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_settings_test exception ${e.message}`);
                return;
            }
            handle_result(json['error'], json['message'], json['redirect']);
        })
        .fail(function (jqXHR, text, error) {
            console.log(`bc_settings_test ${text} ${error}`);
            handle_result(true, error);
        });
});
    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_forwarder_test exception ${e.message}`);
                return;
            }
            handle_result(json['error'], json['message'], json['redirect']);
        })
        .fail(function (jqXHR, text, error) {
            console.log(`bc_forwarder_test ${text} ${error}`);
            handle_result(true, error);
        });
});
