    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_signup_help exception ${e.message}`);
                return;
            }
        ...
        .fail(function (jqXHR, text, error) {
            console.log(`bc_signup_help ${text} ${error}`);
    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_signup_submit exception ${e.message}`);
                return;
            }
            handle_result(json['error'], json['message'], json['redirect']);
        })
        .fail(function (jqXHR, text, error) {
            console.log(`bc_signup_submit ${text} ${error}`);
        });
});
    ...
    jQuery.ajax({
        ...
        .done(function (data) {
            ...
            try {
                ...
                console.log(`bc_signup_link exception ${e.message}`);
                return;
            }
            handle_result(json['error'], json['message'], json['redirect']);
        })
        .fail(function (jqXHR, text, error) {
            console.log(`bc_signup_link ${text} ${error}`);
        });
});
        ...
        jQuery.ajax({
            ...
            .done(function (data) {
                ...
                try {
                    ...
                    console.log(`bc_signup_delete exception ${e.message}`);
                    return;
                }
                handle_result(json['error'], json['message'], json['redirect']);
            })
            .fail(function (jqXHR, text, error) {
                console.log(`bc_signup_delete ${text} ${error}`);
            });
    }
});     
